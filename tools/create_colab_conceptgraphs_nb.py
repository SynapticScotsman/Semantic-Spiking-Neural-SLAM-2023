...
cells = [
    ...
    code("import os, subprocess, time",
         ...
         "    'supervision','open3d','faiss-cpu','openai','imageio', label='core deps')",
         ...
         "",
         "r = subprocess.run(['python','-c','import conceptgraph, gradslam, chamferdist'],",
         "                   capture_output=True, text=True)",
         "if r.returncode != 0:",
         "    raise RuntimeError('post-install import check failed:' + chr(10) + r.stderr[-2000:])",
         "print('conceptgraph + gradslam + chamferdist import OK')",
         "",
