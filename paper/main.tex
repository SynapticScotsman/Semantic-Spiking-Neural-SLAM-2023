...
% artifact file. Provenance lives ONLY in "% provenance:" comments, because the
% rendered PDF shows real citations/URLs, never repo-internal pointers,
% because the document is shared. Pending numbers are marked \todo{}.
% =========================================================================
...
\IEEEauthorrefmark{5}Western Sydney University, Sydney, Australia\\
\todo{contact email for the corresponding author}}}

\maketitle

% -------------------------------------------------------------------------
% PAGE-1 TEASER. A full-width float declared this early lands at the top of
% page 1's text area, under the title block. If it drifts to page 2 in your
% build, the usual fixes are (a) keep [!t], (b) add \usepackage{stfloats},
% or (c) move this block to just before \section{Introduction}.
% Regenerate with:  python tools/make_hero_figure.py
% Every photo, path, field and number in it is read from the measured
% inspector payloads; nothing is drawn by hand.
% -------------------------------------------------------------------------
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{figures/hero.pdf}
\caption{\textbf{The whole system, working, on public data.}
