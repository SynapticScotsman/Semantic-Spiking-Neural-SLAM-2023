...
\captionof{figure}{\textbf{What the map \emph{is}.} Where a scene graph
...
walk superpose into 8{,}192 phases, 32\,KB, a size fixed before the robot
moves and unchanged by how much it then sees.
...
\textbf{(d)} Two robots' maps combine by addition. The sum equals the
