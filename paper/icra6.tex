...
% Hero figure. cuted's strip guaranteed page-1 placement but breaks too
% much (Paul, 2026-08-18); as a plain figure* LaTeX will defer it to the
% top of page 2, which is accepted.
% Regenerate with:  python tools/make_hero_figure.py
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures/hero.png}
\caption{The whole system, drawn from its own state. Every
